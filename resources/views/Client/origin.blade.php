    ...
    <div class="icons">
        <ul>
            ...
            @if(Session::has('customer'))
                <li class="user-btn">
                    <a class="nav-link" href="{{route('client.customer')}}"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-person-circle" viewBox="0 0 16 16">
        ...
        <div class="row">
            ...
            <div class="col-5">
                <div class="container">
                    ...
                    <p class="title-1">Highlands Coffee® Là Của Chúng Mình.</p>
                </div>
