        ...
        <div class="row">
            <div class="col-3">
                <div class="sidebar-customer">
                    <a href="#" class="logo">
                        <div class="logo-name">Quach Dai Nhu Son</div>
                    </a>
                    <ul class="side-menu">
                        <li class="active"><a href="{{route('client.customer')}}"><i class='bx bx-group'></i>Thông Tin Người Dùng</a></li>
                        <li><a href="{{route('client.history_order',$customer)}}"><i class='bx bx-group'></i>Lịch Sử Đơn Hàng</a></li>
                    </ul>
                    <ul class="side-menu">
                        <li>
